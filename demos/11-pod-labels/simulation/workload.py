...
SCENARIOS = {
    "crashloop": {
        ...
        "prefer": [["undo", "routing-tier", "stable"], ["add", "health", "degraded"]],
        "title": "Crash loop",
    ...
    "restart": {
        ...
        "title": "One restart",
        "why": "Same counter as a crash loop. The drain makes it expected, so the right answer is no label.",
    },
    "oom": {
    ...
    "squeeze": {
        ...
        "why": "No single metric crossed its alert line. Together they describe a pod that cannot keep up.",
    },
    "probe": {
        ...
        "prefer": [["undo", "routing-tier", "stable"], ["add", "traffic", "drain"]],
        "title": "Failing readiness",
        "why": "Six in a row with the same upstream timeout: stop routing to it until the dependency is back.",
    },
    "egress": {
        ...
        "prefer": [["undo", "routing-tier", "stable"], ["add", "security", "quarantined"]],
        "title": "Denied egress",
    ...
    "healthy": {
        ...
        "prefer": [
            ["undo", "health", "degraded"],
            ["undo", "traffic", "drain"],
            ["undo", "pressure", "memory"],
            ["add", "routing-tier", "stable"],
        ],
        "title": "Back to healthy",
        "why": "Recovery is a judgment too: is this newer evidence strong enough to take a warning off?",
    },
    "attested": {
        ...
        "prefer": [["undo", "security", "quarantined"]],
        "title": "Image verified",
        "why": "A quarantine should lift only on evidence about the image, not on good latency numbers.",
    },
    "batch": {
        ...
        "prefer": [["add", "routing-tier", "batch"]],
        "title": "Batch finished",
        "why": "Nothing failed. The log says what kind of work this pod does, which is what a routing label claims.",
    },
}
...
def routine_logs():
    while True:
        print(json.dumps({
            "event": "routine_heartbeat", "at": time.time_ns(),
            "message": random.choice(ROUTINE), "synthetic_stimulus": True,
        }), flush=True)
